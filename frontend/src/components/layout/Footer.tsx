            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-gray-400 text-sm max-w-md">
                            Discover millions of books from around the world. From classics to contemporary,
                            we bring the joy of reading to your doorstep at affordable prices.
                        </p>
                        <div className="flex items-center gap-4 mt-6">
                            <a
                                href="#"
                                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-purple-500/20 transition"
                            >
                ...
                <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-gray-500 text-sm">
                        © {currentYear} World of Books Scraper. All rights reserved.
                    </p>
                    <p className="text-gray-500 text-sm">
                        Data sourced from{' '}
                        <a
